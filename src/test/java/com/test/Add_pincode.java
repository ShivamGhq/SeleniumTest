...
public class Add_pincode {
	...
	public static void runTest() throws Exception {
		...
		login = new Add_pincode_Page(Driver);
		test.info("Click on the Grocery Icon");

		Log.info("Clicking on  the Grocery Item");
		login.Grocery();
		
		Driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		// info(details)

		test.info("Enter the pin code you want ");
