...
import com.test.*;
import Pages.CheckAlreadyRegistered_Page;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;



public class CheckRegistered_With_MobileNumber {
	public static String browser;
	static WebDriver Driver;
	public static WebElement element ;
	static ExtentHtmlReporter htmlReporter;
	static ExtentReports extent;
	static Logger Log = LogManager.getLogger(CheckRegistered_With_MobileNumber.class);
	...
	public static void runTest() throws Exception {
		CheckAlreadyRegistered_Page login;
		...
		login = new CheckAlreadyRegistered_Page(Driver);
		// log(Status, details)
		...
		Log.info("enter Mobile Mobile Number");
