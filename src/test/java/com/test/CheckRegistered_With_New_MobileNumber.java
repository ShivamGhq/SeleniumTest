...
import com.test.*;
import Pages.CheckRegistered_With_NEW_Number_Page;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;



public class CheckRegistered_With_New_MobileNumber {
	public static String browser;
	static WebDriver Driver;
	public static WebElement element ;
	static ExtentHtmlReporter htmlReporter;
	static ExtentReports extent;
	static Logger Log = LogManager.getLogger(CheckRegistered_With_New_MobileNumber.class);
	...
	public static void runTest() throws Exception {
		CheckRegistered_With_NEW_Number_Page login;
		...
		login = new CheckRegistered_With_NEW_Number_Page(Driver);
		// log(Status, details)
		...
		test.log(Status.INFO, "Enter the Mobile Number");
