...
public class CreateAccount {
	...
	public static void runTest() throws Exception {
		...
		ExtentTest test = extent.createTest("Flipkart Create Account ", "Sample description");
		...
		login = new CreateAccountPage(Driver);
		// log(Status, details)
				
		test.log(Status.INFO, "Click on the Login Tab ");
		Log.info("Click on loginTab");
		...
		Log.info("Click on the Account Tab");
		
		login.clickAcount();
		
		login.CheckContinueIsDisplayed();
