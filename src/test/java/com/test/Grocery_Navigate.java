...
import Pages.Grocery_Navigate_Page;




public class Grocery_Navigate {
	public static String browser;
	static WebDriver Driver;
	public static WebElement element ;
	static ExtentHtmlReporter htmlReporter;
	static ExtentReports extent;
	static Logger Log = LogManager.getLogger(Grocery_Navigate.class);
	...
	public static void runTest() throws Exception {
		...
		login = new Grocery_Navigate_Page(Driver);
		// info(details)

		test.info("Click on the Grocery Tab ");
		Log.info("Click on the Grocery Tab");
		...
		test.info("Click on the Location Tab to select the Current Location");
		Log.info("click on Navigate Icon ");
		login.enterpincode();
