...
import com.test.*;
import Pages.InvalideloginPage;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;



public class InvalideLogin {
	public static String browser;
	static WebDriver Driver;
	public static WebElement element ;
	static ExtentHtmlReporter htmlReporter;
	static ExtentReports extent;
	static Logger Log = LogManager.getLogger(InvalideLogin.class);
	...
	public static void runTest() throws Exception {
		...
		login = new InvalideloginPage(Driver);
		// info(details)
		...
		test.info("Enter Invalide Number to check its working or not");
		Log.info("enter invalidenumber");
		login.enterNumber();
		//	Driver.wait(5);
		Driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
		...
		Log.info("Click on the Enter Otp Button");
		login.enterotp();
		login.IsDisplayed();
