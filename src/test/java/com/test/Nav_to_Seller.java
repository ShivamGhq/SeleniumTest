...
import Pages.Navigate_to_Seller_Page;



public class Nav_to_Seller {
	public static String browser;
	static WebDriver Driver;
	public static WebElement element ;
	static ExtentHtmlReporter htmlReporter;
	static ExtentReports extent;
	static Logger Log = LogManager.getLogger(Nav_to_Seller.class);
	...
	public static void runTest() throws Exception {
		...
		login = new Navigate_to_Seller_Page(Driver);
		// info(details)
		test.info("Navigate onn seller Tab ");

		// info(details)
		test.info("Click on the Seller Tab ");
		
		Log.info("Click on the seller Tab ");


		login.HitSellerButton();
